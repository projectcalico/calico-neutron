...
class L3_NAT_with_dvr_db_mixin(l3_db.L3_NAT_db_mixin,
    ...
    def delete_floatingip(self, context, id):
        ...
        floatingip_dict = self._delete_floatingip(context, id)
        self._notify_floating_ip_change(context, floatingip_dict)
    ...
    def _notify_floating_ip_change(self, context, floating_ip):
        ...
        if is_distributed_router(router):
            host = self.get_vm_port_hostid(context, fixed_port_id)
